...
public class OAuth2AuthenticationSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public OAuth2AuthenticationSuccessHandler(AuthService authService, AuthProperties authProperties) {
    ...
    public void onAuthenticationSuccess(
        ...
        String redirectUri = UriComponentsBuilder.fromUriString(authProperties.frontendBaseUrl())
                ...
                .queryParam("usrId", tokenResponse.user().usrId())
                .queryParam("tenantId", tokenResponse.user().tenantId())
                .build(true)
                .toUriString();
