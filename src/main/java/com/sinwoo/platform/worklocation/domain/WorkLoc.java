package com.sinwoo.platform.worklocation.domain;
...
public class WorkLoc extends BaseEntity {
    ...
    public static WorkLoc create(
        ...
        return new WorkLoc(tenantId, coId, workLocCd, workLocNm, clntCoNm, ctryCd, regionCd, cityNm, addr1, stsCd);
    }
