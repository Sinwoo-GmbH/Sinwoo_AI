...
public class PayTxn extends BaseEntity {
    ...
    public static PayTxn create(
        ...
        return new PayTxn(tenantId, subsId, payTpCd, payStsCd, payAmt, currCd, pgCd, pgTxnNo, aprvDtm, failMsg);
    }
}
