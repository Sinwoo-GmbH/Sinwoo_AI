...
public class SubscrPlan extends BaseEntity {
    ...
    public static SubscrPlan create(
            String planCd,
            String planNm,
            String tenantTpCd,
            String billCyclCd,
        ...
        return new SubscrPlan(planCd, planNm, tenantTpCd, billCyclCd, currCd, baseAmt, usrLmtCnt, useYn);
    }
}
