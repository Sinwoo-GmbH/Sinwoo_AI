...
public class UsrOauthIdentity extends BaseEntity {
    ...
    public static UsrOauthIdentity create(
            Long usrId,
            Long tenantId,
            String oauthProvCd,
            String oauthSub,
        ...
        return new UsrOauthIdentity(usrId, tenantId, oauthProvCd, oauthSub, eml, emlVrfyYn, lastLgnDtm);
    }
