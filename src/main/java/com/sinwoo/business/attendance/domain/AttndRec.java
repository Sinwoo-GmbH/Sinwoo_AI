...
public class AttndRec extends BaseEntity {
    ...
    public static AttndRec createCheckedIn(
            Long tenantId,
            Long coId,
            Long usrId,
            Long empId,
        ...
        return new AttndRec(tenantId, coId, usrId, empId, attndDt, chkinDtm, null, AttndStatusCd.CHECKED_IN);
    }

    public static AttndRec createManual(
            Long tenantId,
            Long coId,
            Long usrId,
            Long empId,
    ...
    public void applyCheckIn(OffsetDateTime value) {
        ...
        if (chkoutDtm == null) {
            attndStsCd = AttndStatusCd.CHECKED_IN;
        }
    }
    ...
    public void applyCheckOut(OffsetDateTime value) {
        ...
        chkoutDtm = value;
        attndStsCd = AttndStatusCd.CHECKED_OUT;
    }
    ...
    private static String resolveManualStatus(OffsetDateTime checkInValue, OffsetDateTime checkOutValue, String attndStsCd) {
        return AttndStatusCd.resolveManualStatus(checkInValue, checkOutValue, attndStsCd);
    }
}
