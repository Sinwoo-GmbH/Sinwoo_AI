package com.sinwoo.department.domain;
...
public class Department extends BaseEntity {
    ...
    private Department(Long tenantId, Long coId, String deptCd, String deptNm, Long upDeptId, Integer deptLvlNo, String stsCd) {
    ...
    public static Department create(
        ...
        return new Department(tenantId, coId, deptCd, deptNm, upDeptId, deptLvlNo, stsCd);
    }
}
