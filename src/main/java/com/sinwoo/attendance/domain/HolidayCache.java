...
public class HolidayCache extends BaseEntity {
    ...
    public static HolidayCache create(
            String ctryCd,
            String regionCd,
            LocalDate holiDt,
            String holiNmLoc,
        ...
        return new HolidayCache(ctryCd, regionCd, holiDt, holiNmLoc, holiNmEn, globYn, srcNm);
    }
