package com.sinwoo.leave.support;
...
public final class LeaveBizConst {
    ...
    private static final Map<String, String> LEAVE_TYPE_TO_CODE = Map.of(
            "annual leave", "AN",
            "sick leave", "SICK",
            "marriage leave", "MARR",
    ...
    private static final Map<String, String> UNIT_TO_CODE = Map.of(
            "full day", DAY_FULL,
    ...
    public static String normalizeLeaveType(String value) {
        ...
        return LEAVE_TYPE_TO_CODE.getOrDefault(trimmed.toLowerCase(Locale.ROOT), VAC_SPECIAL);
    }

    public static String leaveTypeLabel(String code) {
        return LEAVE_TYPE_TO_LABEL.getOrDefault(normalizeCode(code), "Special Leave");
    }
    ...
    public static String normalizeDayType(String value) {
        ...
        return UNIT_TO_CODE.getOrDefault(trimmed.toLowerCase(Locale.ROOT), DAY_FULL);
    }

    public static String dayTypeLabel(String code) {
        return UNIT_TO_LABEL.getOrDefault(normalizeCode(code), "Full Day");
    }
    ...
    public static String statusLabel(String stsCd, String apprStsCd) {
        ...
        return switch (normalizeCode(apprStsCd)) {
    ...
    public static String statusCodeFromLabel(String status) {
