...
public class RoleMenuAuth extends BaseEntity {
    ...
    public static RoleMenuAuth create(
            Long roleId,
            Long mnuId,
            String viewYn,
            String crtYn,
        ...
        return new RoleMenuAuth(roleId, mnuId, viewYn, crtYn, updYn, delYn, aprvYn, exprtYn);
    }
}
