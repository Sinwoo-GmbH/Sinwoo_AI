...
class CompanyControllerTest {
    ...
    void createCompanyReturnsCreatedCompany() throws Exception {
        ...
        CreateCompanyRequest request = new CreateCompanyRequest(2L, "SINWOO_DE", "Sinwoo Germany", "DE-REG-0001", "ACTIVE");
        CompanyResponse response = new CompanyResponse(1L, 2L, "SINWOO_DE", "Sinwoo Germany", "DE-REG-0001", "ACTIVE", now, now);
    ...
    void getCompaniesReturnsAdminListResponse() throws Exception {
        ...
        CompanyListResponse response = new CompanyListResponse(
                1,
                List.of(new CompanyResponse(1L, 2L, "SINWOO_DE", "Sinwoo Germany", "DE-REG-0001", "ACTIVE", now, now))
        );

        given(companyService.getCompanies(2L)).willReturn(response);

        mockMvc.perform(get("/api/v1/companies").param("tenantId", "2"))
