      ...
      <div className="login-shell-inner relative mx-auto flex max-w-7xl flex-col box-border px-4 py-4 sm:px-6 lg:px-8 lg:py-6">
        ...
        <section className="flex flex-1 items-center justify-center py-3 lg:min-h-0 lg:py-0">
            ...
            <div className="mx-auto w-full max-w-[460px] space-y-4">
              <div className="rounded-[24px] border border-slate-200/80 bg-white/80 px-5 py-5 shadow-[0_18px_40px_rgba(15,23,42,0.08)] backdrop-blur">
                <div className="flex items-start gap-4">
                  <div className="w-full max-w-[106px] shrink-0">
                    <Image
                  ...
                  <div className="min-w-0 space-y-2">
                    <p className="font-brand text-[10px] font-semibold uppercase tracking-[0.24em] text-slate-500">
                      {messages.platformEyebrow}
                    </p>
                    <h1 className="font-brand text-[28px] font-semibold tracking-tight text-slate-950">
          ...
          <div className="hidden w-full lg:flex lg:flex-1 lg:items-center">
            <div className="login-desktop-frame grid w-full grid-cols-[minmax(0,1.08fr)_minmax(380px,430px)] overflow-hidden rounded-[32px] border border-slate-200/80 bg-white/80 shadow-[0_28px_60px_rgba(15,23,42,0.10)] backdrop-blur">
              <div className="relative flex h-full flex-col justify-center overflow-hidden bg-[linear-gradient(180deg,rgba(244,248,253,0.95)_0%,rgba(234,240,247,0.92)_100%)] px-10 py-10">
                ...
                <div className="relative flex flex-col gap-8">
                  <div className="flex items-start gap-5">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="max-w-[520px] text-[15px] leading-7 text-slate-600">
                        {messages.platformDescription}
                      </p>
                    </div>
                  </div>
